...
def mlpmain(numlayer, numneuron, layeractivfunc, X2, y11, X2test, y11test):
    ...
    for epoch in range(100):
        ...
        #print("Train Macro F1 Score epoch::", f1_score(ylabel, tocalf1,average='macro'))
        #print("Train Micro F1 Score epoch::", f1_score(ylabel, tocalf1,average='micro'))
    ...
    print("Test Macro F1 Score::", f1_score(ylabel, tocalf1, average='macro'))
    print("Test Micro F1 Score::", f1_score(ylabel, tocalf1, average='micro'))
